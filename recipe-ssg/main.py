...
minify('scss/newsite.css', 'output/css/newsite.min.css')


newsite_template = env.get_template('newsite.html')

newsite_html = newsite_template.render()
newsite_file_path = "output/newsite.html"

os.makedirs(os.path.dirname(newsite_file_path), exist_ok=True)
with open(newsite_file_path, 'w') as file:
    file.write(newsite_html)